...
public class RequestUtils {
  ...
  public static JSONObject getReturnJson(String url) {
    try {
      ...
      if (a[0] == '[' && a[1] == ']') {
        ...
        System.out.println("获取接口数据成功！请求地址：" + httpUrl);
        return JSONObject.parseObject(content);
      }

    } catch (Exception e) {
      System.err.println("请求访问失败:" + url);
      e.printStackTrace();
    }
    return null;
  }
   ...
   * @return JSONObject
   */
  public static String getReturnString(String url) {
   ...
   * @param saveUrl     保存路径
   */
  public static void saveToFile(String resourceUrl, String dir, String saveUrl) {
    FileOutputStream fos = null;
    BufferedInputStream bis = null;
    HttpURLConnection httpUrl = null;
    URL url;
    String fileAddress = dir + saveUrl;// 存储本地文件地址
